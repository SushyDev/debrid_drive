...
The image for this project is available on Docker at `ghcr.io/sushydev/debrid_drive:development`. Below is an example of a `docker-compose.yml` file to set up the project:

```yaml
debrid_drive:
  container_name: debrid_drive
  image: ghcr.io/sushydev/debrid_drive:development
